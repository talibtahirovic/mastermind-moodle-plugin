...
$string['ctx_audience_general'] = 'Allgemeine Öffentlichkeit';
$string['ctx_audience_label'] = 'Zielgruppe';
$string['ctx_audience_other'] = 'Andere...';
$string['ctx_audience_other_placeholder'] = 'Zielgruppe beschreiben';
$string['ctx_audience_professionals'] = 'Berufstätige';
$string['ctx_audience_school'] = 'Schüler/innen';
$string['ctx_audience_university'] = 'Studierende';
$string['ctx_cancel_button'] = 'Abbrechen';
$string['ctx_difficulty_advanced'] = 'Fortgeschritten';
$string['ctx_difficulty_beginner'] = 'Anfänger/innen';
$string['ctx_difficulty_intermediate'] = 'Mittelstufe';
$string['ctx_difficulty_label'] = 'Schwierigkeitsgrad';
$string['ctx_difficulty_mixed'] = 'Gemischte Niveaus';
$string['ctx_emphasis_balanced'] = 'Ausgewogen';
$string['ctx_emphasis_discussion'] = 'Diskussionsorientiert';
$string['ctx_emphasis_label'] = 'Aktivitäten-Schwerpunkt';
$string['ctx_emphasis_practice'] = 'Praxisorientiert';
$string['ctx_emphasis_theory'] = 'Theorieorientiert';
$string['ctx_generate_button'] = 'Vorschau generieren';
$string['ctx_language_label'] = 'Sprache der Inhalte';
$string['ctx_language_unspecified'] = 'Nicht festgelegt';
$string['ctx_modal_subtitle'] = 'Alle Felder sind optional — sie helfen dem Assistenten, den Kurs anzupassen.';
$string['ctx_modal_title'] = 'Kursdetails';
$string['ctx_outcomes_label'] = 'Lernziele';
$string['ctx_outcomes_placeholder'] = 'Was sollen die Lernenden nach diesem Kurs können? z. B. "Eine private Photovoltaikanlage dimensionieren"';
$string['ctx_size_compact'] = 'Kompakt (3–4 Abschnitte)';
$string['ctx_size_extensive'] = 'Umfangreich (8–10 Abschnitte)';
$string['ctx_size_label'] = 'Kursumfang';
$string['ctx_size_standard'] = 'Standard (5–7 Abschnitte)';
$string['ctx_tone_academic'] = 'Akademisch';
$string['ctx_tone_conversational'] = 'Locker';
$string['ctx_tone_label'] = 'Ton & Stil';
$string['ctx_tone_professional'] = 'Professionell';
...
$string['refine_analysis_button'] = 'Neu generieren — verbraucht 1 Analyse-Aktion';
$string['refine_course_button'] = 'Neu generieren — verbraucht 1 Kurserstellungs-Aktion';
$string['refine_error'] = 'Das Ergebnis konnte nicht verfeinert werden. Bitte versuchen Sie es erneut.';
$string['refine_placeholder'] = 'Sagen Sie dem Assistenten, was geaendert werden soll, oder geben Sie zusaetzlichen Kontext...';
$string['regenerate'] = 'Neu erstellen';
$string['report_builder_title'] = 'KI-Berichtsassistent';
$string['report_card_text'] = 'Brauchen Sie einen individuellen Bericht? Beschreiben Sie ihn und ich entwerfe ihn.';
$string['report_close'] = 'Schliessen';
$string['report_disclaimer'] = 'KI-generierter Bericht — pruefen Sie die Daten, bevor Sie sich darauf verlassen.';
$string['report_download_csv'] = 'CSV';
$string['report_download_label'] = 'Herunterladen:';
$string['report_download_pdf'] = 'PDF';
$string['report_download_xlsx'] = 'XLSX';
$string['report_draft_button'] = 'Bericht entwerfen';
$string['report_error_generic'] = 'Der Bericht konnte nicht erstellt werden. Bitte versuchen Sie es erneut.';
$string['report_example_1'] = 'Liste der Teilnehmer/innen, die in den letzten 30 Tagen nicht auf den Kurs zugegriffen haben';
$string['report_example_2'] = 'Zeige die Bewertung jedes Teilnehmers fuer jeden Test in diesem Kurs';
$string['report_example_3'] = 'Welche Aufgaben haben noch unbewertete Abgaben?';
$string['report_examples_intro'] = 'Probieren Sie eines dieser Beispiele oder beschreiben Sie Ihren eigenen Bericht:';
$string['report_failed'] = 'Ich konnte diesen Bericht nicht erstellen — formulieren Sie Ihre Anfrage bitte um.';
$string['report_footnote'] = 'Komplexe Anfragen muessen ggf. umformuliert werden.';
$string['report_generate_button'] = 'Bericht erstellen — verbraucht 1 Berichtsaktion';
$string['report_generated_on'] = 'Erstellt {$a}';
$string['report_generating'] = 'Bericht wird erstellt...';
$string['report_input_placeholder'] = 'Beschreiben Sie den gewuenschten Bericht oder wie der aktuelle verfeinert werden soll...';
$string['report_no_rows'] = 'Keine passenden Daten — verfeinern Sie Ihre Anfrage';
$string['report_showing_rows'] = '{$a->shown} von {$a->total} Zeilen';
$string['report_total_rows'] = '{$a} Zeilen';
