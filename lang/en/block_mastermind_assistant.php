...
$string['connect_recover_intro'] = 'Your account was created and the API key below is valid. The automatic save failed because the connection token expired. Copy the key, open the settings page, click "Paste it manually", and paste it there to finish connecting.';
$string['connect_recover_open_settings'] = 'Open settings to paste the key';
...
$string['ctx_audience_general'] = 'General public';
$string['ctx_audience_label'] = 'Target audience';
$string['ctx_audience_other'] = 'Other...';
$string['ctx_audience_other_placeholder'] = 'Describe the audience';
$string['ctx_audience_professionals'] = 'Professionals';
$string['ctx_audience_school'] = 'School students';
$string['ctx_audience_university'] = 'University students';
$string['ctx_cancel_button'] = 'Cancel';
$string['ctx_difficulty_advanced'] = 'Advanced';
$string['ctx_difficulty_beginner'] = 'Beginner';
$string['ctx_difficulty_intermediate'] = 'Intermediate';
$string['ctx_difficulty_label'] = 'Difficulty level';
$string['ctx_difficulty_mixed'] = 'Mixed levels';
$string['ctx_emphasis_balanced'] = 'Balanced';
$string['ctx_emphasis_discussion'] = 'Discussion-focused';
$string['ctx_emphasis_label'] = 'Activity emphasis';
$string['ctx_emphasis_practice'] = 'Practice-focused';
$string['ctx_emphasis_theory'] = 'Theory-focused';
$string['ctx_generate_button'] = 'Generate preview';
$string['ctx_language_label'] = 'Content language';
$string['ctx_language_unspecified'] = 'Not specified';
$string['ctx_modal_subtitle'] = 'All fields are optional — they help the assistant tailor the course.';
$string['ctx_modal_title'] = 'Course details';
$string['ctx_outcomes_label'] = 'Learning outcomes';
$string['ctx_outcomes_placeholder'] = 'What should learners be able to do after this course? e.g. "Size a residential solar PV system"';
$string['ctx_size_compact'] = 'Compact (3–4 sections)';
$string['ctx_size_extensive'] = 'Extensive (8–10 sections)';
$string['ctx_size_label'] = 'Course size';
$string['ctx_size_standard'] = 'Standard (5–7 sections)';
$string['ctx_tone_academic'] = 'Academic';
$string['ctx_tone_conversational'] = 'Conversational';
$string['ctx_tone_label'] = 'Tone & style';
$string['ctx_tone_professional'] = 'Professional';
...
$string['refine_analysis_button'] = 'Regenerate — uses 1 analysis action';
$string['refine_course_button'] = 'Regenerate — uses 1 course creation action';
$string['refine_error'] = 'Could not refine the result. Please try again.';
$string['refine_placeholder'] = 'Tell the assistant what to change or add context...';
$string['regenerate'] = 'Regenerate';
$string['report_builder_title'] = 'AI Report Builder';
$string['report_card_text'] = 'Need a custom report? Describe it and I\'ll draft it.';
$string['report_close'] = 'Close';
$string['report_disclaimer'] = 'AI-generated report — verify the data before relying on it.';
$string['report_download_csv'] = 'CSV';
$string['report_download_label'] = 'Download:';
$string['report_download_pdf'] = 'PDF';
$string['report_download_xlsx'] = 'XLSX';
$string['report_draft_button'] = 'Draft a report';
$string['report_error_generic'] = 'Could not generate the report. Please try again.';
$string['report_example_1'] = 'List students who have not accessed the course in the last 30 days';
$string['report_example_2'] = 'Show each student\'s grade for every quiz in this course';
$string['report_example_3'] = 'Which assignments still have submissions waiting to be graded?';
$string['report_examples_intro'] = 'Try one of these examples, or describe your own report:';
$string['report_failed'] = 'I couldn\'t build that report — try rephrasing your request.';
$string['report_footnote'] = 'Complex requests may need rephrasing.';
$string['report_generate_button'] = 'Generate report — uses 1 report action';
$string['report_generated_on'] = 'Generated {$a}';
$string['report_generating'] = 'Generating report...';
$string['report_input_placeholder'] = 'Describe the report you need, or how to refine the current one...';
$string['report_no_rows'] = 'No matching data — refine your request';
$string['report_showing_rows'] = 'Showing {$a->shown} of {$a->total} rows';
$string['report_total_rows'] = '{$a} rows';
