...
$functions = [
    ...
    'block_mastermind_assistant_refine_analysis' => [
        'classname'   => 'block_mastermind_assistant\external\refine_analysis',
        'methodname'  => 'execute',
        'description' => 'Refine a previous full analysis result with user feedback (conversational)',
        'type'        => 'write',
        'ajax'        => true,
        'loginrequired' => true,
    ],
    ...
    'block_mastermind_assistant_refine_course' => [
        'classname'   => 'block_mastermind_assistant\external\refine_course',
        'methodname'  => 'execute',
        'description' => 'Refine a previewed AI course structure with user feedback (never creates the course)',
        'type'        => 'write',
        'ajax'        => true,
        'loginrequired' => true,
    ],
